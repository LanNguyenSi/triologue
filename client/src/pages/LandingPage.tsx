...
export const LandingPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 text-gray-900 dark:text-white">
      {/* Nav */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 dark:bg-gray-900/80 backdrop-blur-md border-b border-gray-200 dark:border-gray-200 dark:border-gray-800">
        <div className="max-w-5xl mx-auto px-4 py-3 flex items-center justify-between">
          ...
          <div className="flex gap-2 items-center">
            ...
            <Link
              to="/login"
              className="px-4 py-1.5 text-sm text-gray-700 dark:text-gray-700 dark:text-gray-300 hover:text-gray-900 dark:hover:text-white transition-colors"
            >
              {t('nav.signIn')}
            </Link>
            <Link
      ...
      <section className="pt-32 pb-20 px-4 text-center">
        <div className="max-w-3xl mx-auto">
          ...
          <p className="text-xl text-gray-600 dark:text-gray-600 dark:text-gray-400 mb-3 max-w-2xl mx-auto">
            {t('hero.subtitle1')}
          </p>
          <p className="text-sm text-gray-500 dark:text-gray-500 dark:text-gray-500 dark:text-gray-500 mb-10">
            {t('hero.subtitle2')}
          </p>
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link
              to="/login"
              className="px-8 py-3 bg-gray-100 dark:bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 border border-gray-300 dark:border-gray-300 dark:border-gray-700 font-medium rounded-xl transition-colors"
            >
              {t('hero.login')}
            </Link>
          </div>
          {/* Live indicator */}
          <div className="mt-8 flex items-center justify-center gap-2 text-sm text-gray-600 dark:text-gray-600 dark:text-gray-400">
            <div className="w-2 h-2 bg-green-400 rounded-full animate-pulse"></div>
            <span>{t('hero.liveStatus')} <a href="https://triologue.duckdns.org/room/onboarding" className="text-blue-600 dark:text-blue-400 hover:underline">triologue.duckdns.org</a></span>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-4 border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-3xl mx-auto text-center mb-10">
          ...
          <p className="text-gray-600 dark:text-gray-400">{t('how.subtitle')}</p>
        </div>
        <div className="max-w-2xl mx-auto space-y-4">
          {[
            ...
            <div key={s.step} className="flex items-start gap-4 p-4 bg-gray-100 dark:bg-gray-800/50 rounded-xl border border-gray-300 dark:border-gray-700">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600 dark:text-gray-400 mt-0.5">{t(s.subKey)}</div>
              </div>
            </div>
          ))}
        </div>
      ...
      <section className="py-16 px-4 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 dark:text-gray-400">{t('beta.subtitle')}</p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {BETA_FEATURES_KEYS.map(f => (
              <div key={f.titleKey} className="p-4 bg-gray-100 dark:bg-gray-800 rounded-xl border border-gray-300 dark:border-gray-700 hover:border-gray-600 transition-colors">
                <div className="text-2xl mb-2">{f.icon}</div>
                <div className="font-semibold mb-1">{t(f.titleKey)}</div>
                <div className="text-sm text-gray-600 dark:text-gray-400">{t(f.descKey)}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-16 px-4 border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-10">
            ...
            <p className="text-gray-600 dark:text-gray-400">{t('roadmap.subtitle')}</p>
          </div>
      ...
      <section className="py-16 px-4 bg-gray-50 dark:bg-gray-800/30 border-t border-gray-200 dark:border-gray-800">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-8">{t('team.subtitle')}</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            {[
              ...
              <div key={m.name} className={`flex-1 p-5 rounded-xl border ${m.color}`}>
                ...
                <div className="text-xs text-gray-600 dark:text-gray-400 mb-2">{t(m.roleKey)}</div>
                <div className="text-sm text-gray-700 dark:text-gray-300">{t(m.descKey)}</div>
              </div>
            ))}
          </div>
        </div>
      ...
      <footer className="py-8 px-4 border-t border-gray-200 dark:border-gray-800 text-center text-sm text-gray-500 dark:text-gray-500">
        ...
        <p className="mt-3"><a href="/privacy" className="hover:text-gray-700 dark:text-gray-300 transition-colors underline underline-offset-2">{t('footer.privacy')}</a></p>
      </footer>
    </div>
  );
};
