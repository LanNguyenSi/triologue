...
const translations: Record<Language, Record<string, string>> = {
  de: {
    ...
    "nav.a11y.deleteRoom": "Raum löschen: {name}",
    ...
    "app.error.message": "Bitte lade die Seite neu, um fortzufahren.",
    ...
    "inbox.item.markRead": "Als gelesen markieren",
    "inbox.item.delete": "Eintrag löschen",
    ...
    "projects.task.field.title": "Titel",
    "projects.task.field.description": "Beschreibung",
    "projects.task.field.priority": "Priorität",
    "projects.task.field.assignee": "Bearbeiter",
    "projects.task.field.reviewer": "Prüfer",
    "projects.task.field.memoryIds": "Memory-IDs",
    "projects.task.memoryIds.helper": "Optional. Verweise auf Agent-Memory, mit Komma getrennt.",
    "projects.task.advanced": "Erweitert",
    ...
    "projects.attachments.close": "Schließen",
    ...
    "chat.attachFile.remove": "Angehängte Datei entfernen",
    ...
    "admin.agent.configure": "Agent konfigurieren",
    ...
    "admin.a11y.deleteInvite": "Invite-Code löschen: {code}",
    ...
    "agentConfig.toggle.fallback": "Umschalter",
  ...
  en: {
    ...
    "nav.a11y.deleteRoom": "Delete room: {name}",
    ...
    "app.error.message": "Please reload the page to continue.",
    ...
    "inbox.item.markRead": "Mark as read",
    "inbox.item.delete": "Delete item",
    ...
    "projects.task.field.title": "Title",
    "projects.task.field.description": "Description",
    "projects.task.field.priority": "Priority",
    "projects.task.field.assignee": "Assignee",
    "projects.task.field.reviewer": "Reviewer",
    "projects.task.field.memoryIds": "Memory IDs",
    "projects.task.memoryIds.helper": "Optional. Agent memory references, comma-separated.",
    "projects.task.advanced": "Advanced",
    ...
    "projects.attachments.close": "Close",
    ...
    "chat.attachFile.remove": "Remove attached file",
    ...
    "admin.back": "← Back",
    "admin.title": "Admin Panel",
    "admin.agent.configure": "Configure agent",
    ...
    "admin.a11y.deleteInvite": "Delete invite code: {code}",
    ...
    "agentConfig.toggle.fallback": "Toggle",
