...
const translations: Record<Language, Record<string, string>> = {
  de: {
    ...
    "settings.pluginsDesc": "Steuere, welche Plugins fuer deinen Account aktiv sind. Workspace-weite Sperren gelten weiterhin.",
    ...
    "settings.pluginsDisabledForMe": "fuer mich deaktiviert",
